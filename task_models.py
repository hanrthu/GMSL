...
class MultiTaskModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.training_step_outputs.append({"loss": loss, "l1": l1_loss, "bce": bce_loss})
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.validation_step_outputs.append({"affinity_true": y_affinity_true,"affinity_pred": y_affinity_pred,"property_true": y_property_true,"property_pred": y_property_pred})
        return {
    ...
    def test_step(self, batch, batch_idx):
        ...
        #     y_pred, y_true, _, _ = self(batch)
        y_affinity_pred, y_property_pred, y_affinity_true, y_property_true = self(batch)
        self.test_step_outputs.append({"affinity_true": y_affinity_true,"affinity_pred": y_affinity_pred,"property_true": y_property_true,"property_pred": y_property_pred})
        return {
            "affinity_true": y_affinity_true,
            "affinity_pred": y_affinity_pred,
            "property_true": y_property_true,
    ...
    def on_train_epoch_end(self):
        ...
        mae_loss = torch.stack([x["l1"] for x in self.training_step_outputs]).mean().item()
        to_print = (
